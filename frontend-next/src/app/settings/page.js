...
import { Globe, Check, BookOpen, Shield, ChevronRight, ChevronLeft, FileText, Server, Database, BarChart2, Brain, FlaskConical, Building2, ClipboardList, HardDrive, FileCode, Layers, X, Maximize2, Minimize2, ArrowUp, User as UserIcon, LogOut, ShieldCheck } from 'lucide-react'
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.userCard}>
                        <div className={styles.userInfoLeft}>
                            ...
                            <div className={styles.userMeta}>
                                <div className={styles.userNameRow}>
                                    ...
                                    <span className={styles.userRoleBadge}>{user.role || 'user'}</span>
                                </div>
                                <span className={styles.userSubText}>
                                    {t('auth.accountLabel')}: @{user.username} {user.email ? `· ${user.email}` : ''}
                                </span>
                            </div>
                        </div>
                        <div className={styles.userActionsRight}>
                            <button
                                type="button"
                                className={styles.logoutBtnSettings}
